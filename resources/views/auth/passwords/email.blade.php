		    ...
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<div class="auth-form-container text-left">
						...
						<form class="auth-form resetpass-form" action="{{ route('admin.password.email') }}" method="POST">
                            @csrf
						...
						<div class="auth-option text-center pt-5"><a class="app-link" href="{{ route('admin.login') }}" >Log in</a> <span class="px-2">|</span> <a class="app-link" href="{{ route('home') }}" >Home</a></div>
